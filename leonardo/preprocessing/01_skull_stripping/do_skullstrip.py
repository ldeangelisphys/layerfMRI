...
# Function to carry out anatomical (full) skull stripping
...
# Function to carry out skull stripping of the mean functional image
...
# Function to carry out skull stripping of the partial anatomy (T123)
...
# Produce the HTML page with the QC
