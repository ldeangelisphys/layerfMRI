...
atlas_file = gitdir + "/analyses/depth_native/01_registration/juelich_atlas/" + "atlas_juelich_icbm.nii.gz"

targetdir = gitdir + '/analyses/depth_native/data_native/sub_{:02d}/'.format(sub)
...
gitdir + "/analyses/depth_native/01_registration/juelich_atlas/" + atlas_juelich_icbm.nii.gz
