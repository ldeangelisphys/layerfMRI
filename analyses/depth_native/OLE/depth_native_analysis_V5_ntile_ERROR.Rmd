...
# This version contains a mistake which was corrected in V6
Basically here `dplyr::ntile` was used to extract sig voxels at different bins of cortical depth. This is inaccurate, and `base::findInterval` should be used. See explanation in V6.
