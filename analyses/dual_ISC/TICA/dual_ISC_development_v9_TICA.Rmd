...
writeimgs <- function(sub,mat,flavour) {
  nii <- asNifti(mat)
  writeNifti(nii, paste0(TICAdir,"/nii4TICA/",flavour,"_",sub,".nii.gz"))
}

walk2(listsub, mats_Motion, ~ writeimgs(.x, .y, "Motion"))
walk2(listsub, mats_Scrambled, ~ writeimgs(.x, .y, "Scrambled"))
