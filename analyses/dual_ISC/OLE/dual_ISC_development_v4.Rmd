...
pf <- df %>% 
  filter(sub != "sub_08") %>%    # not present
  filter(sub != "sub_05") %>%    # apparently some problems in the late runs
  filter(sub != "sub_06") %>%    # problems with tc_mean()
  filter(sub != "sub_09") %>%    # problems with tc_mean()
  filter(sub != "sub_10") %>%    # problems with tc_mean()
