---
title: "Dual ISC development v6 - a big love nest(3)"
...
# User-defined parameters: choose here which ISC flavour you want
...
load_images <- function(df_taskrun_contrast) {
  ...
  print(paste0(ISC_flavour,"/",this$sub, "_", ISC_flavour,"_task_", this$task,"_run_", this$run, ".nii.gz"))
...
# # ------------- unit test -------------
# df_taskrun_contrast <- df %>% filter(sub == "sub_02", task == 1, run == 1, contrast == "Scrambled")
# df_taskrun_contrast
# 
